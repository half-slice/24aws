...
kinesis = kinesis.connect_to_region("ap-northeast-2") #cwro
...
if __name__ == '__main__':
    ...
    for limit_count in range(1,50): 
        ...
        data = bytes(browser_df.to_json(orient='records'), encoding='utf-8') #cwro
        print(data)
        kinesis.put_record("rostream3", data, "Accesslog")        #cwro                            ###Replace with the name of your stream 
        print("Data posted")
